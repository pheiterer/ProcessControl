...
- Create Angular project with ng: `ng new processcontrol.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`processcontrol.client.esproj`).
